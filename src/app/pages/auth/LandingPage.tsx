...
export function LandingPage({}: LandingPageProps) {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-[#486837]/5 via-white to-white"
      dir="rtl"
    >
      {/* Navigation */}
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-[#ad9f4e]/20">
        <div className="max-w-6xl mx-auto px-3 md:px-4 py-3 md:py-4 flex items-center justify-between gap-2 md:gap-4">
          ...
          >
            ...
            <span className="text-lg md:text-2xl font-bold text-[var(--brand-primary)]">
              مقرأة
            </span>
          </motion.div>
      ...
      <section className="max-w-6xl mx-auto px-3 md:px-4 py-10 md:py-20 text-center">
        ...
        >
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 md:mb-6">
            تعلم القرآن من{" "}
            <span className="text-[var(--brand-primary)]">معلمين معتمدين</span>
          </h1>
      ...
      {isAuthenticated && user?.role === "learner" && (
        <section className="max-w-6xl mx-auto px-3 md:px-4 py-12 md:py-16 bg-gradient-to-r from-orange-50 to-red-50 rounded-3xl mb-12 md:mb-16">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <p className="text-sm md:text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
              سجل نفسك في اختبار مدته دقيقة واحدة فقط! سنحلل أدائك ونربطك بأفضل
              معلم مناسب لمستواك
            </p>
            <button
          ...
          {[
            {
              ...
              specialization: "متخصص في التجويد",
              rating: 4.9,
              gender: "male",
            },
            {
              ...
              <div className="w-16 h-16 md:w-20 md:h-20 mx-auto mb-3 md:mb-4 flex items-center justify-center">
                {teacher.gender === "female" ? (
                  ...
                  >
                    ...
                    {/* Hijab/headscarf */}
                    <path
                      d="M 32 28 Q 50 15 68 28 Q 70 35 68 40 L 32 40 Q 30 35 32 28"
                      fill="#2d5016"
                    />
                  </svg>
                ) : (
                  ...
                  >
                    ...
                    {/* Hair/kufi */}
                    <path
                      d="M 32 25 Q 50 10 68 25 Q 70 32 68 35 L 32 35 Q 30 32 32 25"
                      fill="#333"
                    />
                  </svg>
                )}
      ...
      <footer className="bg-gray-900 text-white mt-12 md:mt-20">
        <div className="max-w-6xl mx-auto px-3 md:px-4 py-8 md:py-12 text-center">
          <p className="text-xs sm:text-sm md:text-base">
            &copy; 2026 مقرأة - منصة تعليم القرآن الكريم
          </p>
        </div>
      </footer>
    </div>
